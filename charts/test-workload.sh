...
SKIP_CONFIGURATION="helm_chart_valid require_labels nodeport_not_used hostport_not_used secrets_used immutable_configmap helm_chart_published default_namespace latest_tag hardcoded_ip_addresses_in_k8s_runtime_configuration deprecated_k8s_features alpha_k8s_apis operator_installed"
SKIP_MICROSERVICE="reasonable_startup_time reasonable_image_size single_process_type zombie_handled sig_term_handled service_discovery shared_database specialized_init_system"
SKIP_STATE="node_drain elastic_volumes database_persistence no_local_volume_configuration"
SKIP_RESILIENCE="liveness readiness pod_delete pod_network_duplication pod_network_latency pod_network_corruption disk_fill pod_memory_hog pod_io_stress pod_dns_error"
SKIP_COMPATIBILITY="rolling_update rolling_downgrade rollback increase_decrease_capacity rolling_version_change cni_compatible"
SKIP_OBSERVABILITY="log_output prometheus_traffic open_metrics routed_logs tracing"
SKIP_SECURITY="privileged_containers privilege_escalation host_network non_root_containers immutable_file_systems hostpath_mounts cpu_limits memory_limits sysctls external_ips selinux_options container_sock_mounts symlink_file_system application_credentials service_account_mapping linux_hardening insecure_capabilities ingress_egress_blocked host_pid_ipc_privileges"
